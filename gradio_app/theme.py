...
def build_theme() -> gr.themes.Base:
    ...
    return gr.themes.Soft(
        ...
        # checkboxes — white inset box, brand-blue check on selected
        checkbox_background_color=SURFACE,
        checkbox_background_color_dark=SURFACE,
        checkbox_background_color_hover=SURFACE,
        checkbox_background_color_hover_dark=SURFACE,
        checkbox_background_color_focus=SURFACE,
        checkbox_background_color_focus_dark=SURFACE,
        ...
        checkbox_border_color_hover=ACCENT_SOFT,
        checkbox_border_color_hover_dark=ACCENT_SOFT,
        checkbox_border_color_focus=ACCENT,
        checkbox_border_color_focus_dark=ACCENT,
        checkbox_border_color_selected=ACCENT,
        checkbox_border_color_selected_dark=ACCENT,
        checkbox_border_radius="5px",
        checkbox_border_width="1px",
        checkbox_shadow="inset 0 1px 2px rgba(1,9,23,0.06)",
        ...
        table_text_color_dark=TEXT_PRIMARY,
        ...
        table_radius="10px",
        table_row_focus=SURFACE_TINT,
        table_row_focus_dark=SURFACE_TINT,
        # code
        code_background_fill=SURFACE,
        code_background_fill_dark=SURFACE,
        # accent
        color_accent=ACCENT,
