...
#
# Task budget (full mode, 23 tasks):
#   18 cat  (~78%) — 9 fast + 9 accurate
#    2 grep (~9%)  — both --semantic, with different queries (regex grep is
...
register_tasks() {
  ...
  # cat fast, cat accurate, batch cat, grep, grep --semantic.
  # ============================================================
  ...
  # 4. grep --semantic — vector search over image captions (people)
  ...
  # 5. grep --semantic — vector search over image captions (outdoor scene)
  ...
  # ============================================================
  # Full mode (6-22): broader coverage of cat / grep / find / wc / sql.
  # ============================================================

  # ---- More cat fast (7 more = 8 total fast) ----
  ...
  # 20. cat accurate — sensitive content check
  ...
  # 21. find — tree overview for onboarding
  ...
  # 22. wc — bulk token cost estimate for full collection (#34)
