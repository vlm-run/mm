"""vlmctx find -- find and list files with metadata, tree view, schema."""
...
def find_cmd(
    ...
    Modes:
      ...
      vlmctx find ~/data --tree --depth 2     # hierarchical tree view
      vlmctx find ~/data --schema             # column schema introspection

    \b
    Examples:
      vlmctx find ~/data --kind image                           # images only
      vlmctx find ~/data --ext .pdf,.docx --sort size -r        # docs by size
      vlmctx find ~/data --columns name,kind,size --limit 20    # custom columns
      vlmctx find ~/data --tree --kind video                    # video tree
      vlmctx find ~/data --min-size 1mb --sort size -r          # large files
    """
