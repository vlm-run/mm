"""Context -- the main Python API for vlmctx."""
...
class Context:
    ...
    def filter(
        ...
        *,
        ...
        new_ctx._vlmctx_dir = self._vlmctx_dir
        return new_ctx
    ...
    def save(self) -> Path:
        """Write the index to .vlmctx/index.parquet."""
        self._vlmctx_dir.mkdir(parents=True, exist_ok=True)
        parquet_path = self._vlmctx_dir / "index.parquet"
