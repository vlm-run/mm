...
│   │   │   ├── document_url.py # document-url (whole doc → document_url part; low-level primitive)
│   │   │   ├── markdown.py     # markdown (document_url → gateway OCR → markdown; model-parametrized, default dots-mocr)
