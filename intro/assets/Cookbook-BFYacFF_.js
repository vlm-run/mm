import{j as e}from"./index-Da29PAw0.js";const n={path:"~/data/mmbench-tiny/",files:9,size:"43.1 MB",contents:["1-vqa-car.jpg","BillDownload-8pg.pdf","audio_health_check.wav","bakery.mp4","dogs.jpg","fine-tuning-deck.pdf","how_to_build_an_mvp.mp3","invoice.jpg","two_minute_rules.mp3"]},o=[{id:"wc",title:"Count files, size & tokens",desc:"Get a quick summary of what's in a directory — file counts, total size, estimated lines and tokens, broken down by kind.",examples:[{cmd:"mm wc ~/data/mmbench-tiny/",output:`kind      files  size      lines(est) tokens(est) tok_per_mb
...
vlmrun           https://mm-ctx.ngrok.io/v1     Qwen/Qwen3.5-0.8B`},{cmd:"mm config show",output:`mode     whisper_model  audio_speed  beam_size
fast     tiny           2.0          1
accurate medium         1.0          5`}]}];function s({cmd:t,output:i,comment:a}){return e.jsx("div",{className:"mb-3",children:e.jsxs("pre",{className:"code-block",children:[a&&e.jsxs(e.Fragment,{children:[e.jsxs("span",{className:"comment",children:["# ",a]}),`
`]}),e.jsx("span",{className:"prompt",children:"$ "}),t,i&&e.jsxs(e.Fragment,{children:[`

`,e.jsx("span",{className:"output",children:i})]})]})})}function m({recipe:t}){return e.jsxs("section",{id:`recipe-${t.id}`,className:"panel p-6 animate-slide-up",children:[e.jsx("h2",{className:"text-[16px] font-semibold text-[var(--text-primary)] mb-1",children:t.title}),e.jsx("p",{className:"text-[13px] text-[var(--text-secondary)] mb-4",children:t.desc}),t.examples.map((i,a)=>e.jsx(s,{cmd:i.cmd,output:i.output,comment:i.comment},a))]})}function c(){return e.jsxs("div",{className:"animate-slide-up max-w-3xl mx-auto space-y-6",children:[e.jsxs("div",{children:[e.jsx("h1",{className:"text-[22px] font-bold text-[var(--text-primary)]",children:"Cookbook"}),e.jsx("p",{className:"text-[14px] text-[var(--text-secondary)] mt-1",children:"Hands-on recipes using a 9-file, 43 MB multimodal dataset — images, PDFs, video, and audio."})]}),e.jsxs("div",{className:"panel p-5",children:[e.jsxs("div",{className:"flex items-center gap-3 mb-3",children:[e.jsx("span",{className:"font-mono text-[11px] font-semibold uppercase tracking-wider text-[var(--forest)]",children:"Dataset"}),e.jsx("code",{className:"font-mono text-[12px] text-[var(--text-secondary)] bg-[var(--bg)] border border-[var(--border)] rounded px-2 py-0.5",children:n.path}),e.jsxs("span",{className:"font-mono text-[11px] text-[var(--text-muted)]",children:[n.files," files · ",n.size]})]}),e.jsx("div",{className:"flex flex-wrap gap-1.5",children:n.contents.map(t=>{const i=t.split(".").pop(),a={jpg:"#C9623E",pdf:"#B8960F",mp4:"#1A3C2B",mp3:"#2D8659",wav:"#2D8659"}[i]||"var(--text-muted)";return e.jsx("span",{className:"font-mono text-[11px] border rounded px-2 py-0.5",style:{borderColor:a+"40",color:a,background:a+"08"},children:t},t)})})]}),e.jsxs("div",{className:"panel p-4",children:[e.jsx("span",{className:"font-mono text-[10px] font-semibold uppercase tracking-wider text-[var(--text-muted)] block mb-2",children:"Recipes"}),e.jsx("div",{className:"flex flex-wrap gap-1.5",children:o.map(t=>e.jsx("button",{onClick:()=>{var i;return(i=document.getElementById(`recipe-${t.id}`))==null?void 0:i.scrollIntoView({behavior:"smooth",block:"start"})},className:"font-mono text-[11px] text-[var(--forest)] border border-[var(--border)] rounded px-2 py-0.5 hover:border-[var(--forest)] transition-colors cursor-pointer bg-transparent",children:t.title},t.id))})]}),o.map(t=>e.jsx(m,{recipe:t},t.id))]})}export{c as default};
