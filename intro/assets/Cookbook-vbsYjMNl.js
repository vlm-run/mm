import{j as e}from"./index-BtVeJB-U.js";const o={path:"~/data/mmbench-tiny/",files:9,size:"43.1 MB",contents:["1-vqa-car.jpg","BillDownload-8pg.pdf","audio_health_check.wav","bakery.mp4","dogs.jpg","fine-tuning-deck.pdf","how_to_build_an_mvp.mp3","invoice.jpg","two_minute_rules.mp3"]},n=[{id:"wc",title:"Count files, size & tokens",desc:"Get a quick summary of what's in a directory — file counts, total size, estimated lines and tokens, broken down by kind.",examples:[{cmd:"mm wc ~/data/mmbench-tiny/",output:`kind      files  size      lines(est) tokens(est) tok_per_mb
